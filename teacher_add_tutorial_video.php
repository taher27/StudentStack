        ...
        <div class='container' style='margin-left: 20%;' >
            <div class='container'>
                ...
                <div class='frontbox' style="margin-right: 400px;">
                    <div class='login'>
                        <font color="blue">ADD TUTORIAL (VIDEO)</font><br>
                        <div class='inputbox1'>
                            <?php
...
if(isset($_POST['submit']))
{
    ...
    $insertquery = mysqli_query($con, "insert into tutorial_video (sub_id,vid_name,vid_path) values ($subid,'$tutorialname','$tutorialpath')") or die(mysqli_error($con));
    if($insertquery)
    {
