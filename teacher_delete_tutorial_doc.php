...
<html>
    <head>
      ...
      $sql = mysqli_query($con, "select * from tutorial_doc where sub_id=$subid");
      $srno = 1;
      if(mysqli_num_rows($sql)<1)
      {
          echo "<h6><center>No Tutorials present</center></h6>";
      }
      else
      {
          ...
          {
              echo "<tr><center><td>$srno</td><td>$row[2]</td><td>$row[3]</td><td><a class='buttonlink' href='teacher_delete_tutorial_doc2.php?docid=$row[0]'>DELETE</a></td></center></tr>";
              $srno++;
