    ...
    <head>
      ...
      <div>
            <div class='row' style='margin-left: 350px;  margin-top: 100px;'>
                <div class='col s6 m3 '>
                    <a href="teacher_tutorial_doc.php">
			<div  class='card'>
				<div  class='card-image'>
                                    <img src='images/card4.png' style='height: 150px; border-radius: 15px;'>
                                    <span class='card-title'><h5><center>PDF</center></span>
				</div>
			</div>
                    </a>
		</div>			
                <div class='col s6 m3 '>
                    <a href="teacher_tutorial_video.php">
			<div  class='card'>
				<div  class='card-image'>
                                    <img src='images/card4.png' style='height: 150px; border-radius: 15px;'>
                                    <span class='card-title'><h5><center>Videos</center></span>
				</div>
			</div>
                    </a>
		</div>
